function Stats() {
    return (
        <div className="grid grid-cols-1 p-4 md:p-6 rounded-2xl bg-cyan-600 divide-y divide-white md:divide-y-0 md:divide-x md:divide-white md:grid-cols-3 gap-2 md:gap-4 text-center">
