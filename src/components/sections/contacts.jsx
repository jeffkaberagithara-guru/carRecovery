    ...
    <section className="max-w-6xl mx-auto px-6 py-10 bg-linear-to-r from-cyan-600 to-cyan-700 rounded-3xl text-white shadow-xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
        <div className="hidden lg:block">
          <img
            src="/Tow truck technician.jpg"
            alt="ResQAuto Technician"
            className="w-full max-h-[300px] md:max-h-[400px] rounded-2xl shadow-lg object-cover object-center mx-auto"
          />
        </div>
        ...
        <div>
          ...
          <p className="text-base md:text-lg text-gray-100 mb-6 leading-relaxed">
            Create a free account to track your rescue, get faster service next
            time, and access your service history. <br></br>Sign up to make your
            next roadside rescue even faster.
          </p>
